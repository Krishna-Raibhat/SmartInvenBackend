...
import clothingNotificationPreferenceService from "../services/clothingNotificationPreferenceService.js";
...
export const getPreferences = async (req, res) => {
  try {
    ...
    const preferences = await clothingNotificationPreferenceService.getAllPreferences(owner_id);
...
export const getPreferenceByType = async (req, res) => {
  try {
    ...
    const isEnabled = await clothingNotificationPreferenceService.getPreference(owner_id, type);
...
export const updatePreference = async (req, res) => {
  try {
    ...
    const preference = await clothingNotificationPreferenceService.setPreference(
      owner_id,
      type,
      is_enabled
    );
...
export const updateMultiplePreferences = async (req, res) => {
  try {
    ...
    const results = await clothingNotificationPreferenceService.updateMultiplePreferences(
      owner_id,
      preferences
    );
