import service from '../services/grocerySupplierReturnService.js';
...
export const create = async (req, res) => {
  try {
    ...
    console.error('Error creating grocery supplier return:', err);
...
export const list = async (req, res) => {
  try {
    ...
    console.error('Error listing grocery supplier returns:', err);
    return fail(res, 500, 'SERVER_ERROR', err.message);
  }
};
...
export const getById = async (req, res) => {
  try {
    ...
    console.error('Error fetching grocery supplier return:', err);
    return fail(res, 500, 'SERVER_ERROR', err.message);
  }
};
