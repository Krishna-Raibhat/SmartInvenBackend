// src/controllers/grocerySupplierController.js
import grocerySupplierService from "../services/grocerySupplierService.js";
...
export const create = async (req, res) => {
  try {
    ...
    const supplier = await grocerySupplierService.create({
      owner_id,
      supplier_name,
      phone,
      email: email || null,
...
export const list = async (req, res) => {
  try {
    const owner_id = req.owner.owner_id;
    const suppliers = await grocerySupplierService.list(owner_id);
...
export const getById = async (req, res) => {
  try {
    ...
    const supplier = await grocerySupplierService.getById(owner_id, supplier_id);
...
export const update = async (req, res) => {
  try {
    ...
    const updated = await grocerySupplierService.update(owner_id, supplier_id, patch);
...
export const remove = async (req, res) => {
  try {
    ...
    const deleted = await grocerySupplierService.remove(owner_id, supplier_id);
