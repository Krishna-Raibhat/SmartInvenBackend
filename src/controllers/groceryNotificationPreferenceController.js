...
import groceryNotificationPreferenceService from "../services/groceryNotificationPreferenceService.js";
...
export const getPreferences = async (req, res) => {
  try {
    ...
    const preferences = await groceryNotificationPreferenceService.getAllPreferences(owner_id);
...
export const getPreferenceByType = async (req, res) => {
  try {
    ...
    const isEnabled = await groceryNotificationPreferenceService.getPreference(owner_id, type);
...
export const updatePreference = async (req, res) => {
  try {
    ...
    const preference = await groceryNotificationPreferenceService.setPreference(
      owner_id,
      type,
      is_enabled
    );
...
export const updateMultiplePreferences = async (req, res) => {
  try {
    const owner_id = req.owner.owner_id;
    const preferences = req.body; // { low_stock: true, expiry: false, ... }
    ...
    const results = await groceryNotificationPreferenceService.updateMultiplePreferences(
      owner_id,
      preferences
    );
